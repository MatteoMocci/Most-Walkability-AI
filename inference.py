...
def inference_dual_encoder(
    ...
    loader = DataLoader(
        ...
        # Load the inference pairs
    inference_pairs_path = 'paired_datasets/inference.npy'
    pairs = np.load(inference_pairs_path, allow_pickle=True)

    # We'll need the streetview image paths (assumed to be the first in each tuple)
